...
int main() {
    ...
    printf("Your rounded price is %.1f\n", price); // 20
    printf("Your precise price is %.2f\n", price); // 19.99
    ...
    if(isOnline) {
        ...
        printf("You ARE NOT online %c", symbol);
    } else if(!isPlaying) {
        printf("You ARE playing %c", symbol);
    } else if(isPlaying) {
        printf("You ARE NOT playing %c", symbol);
    } else {
